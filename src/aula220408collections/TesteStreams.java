...
public class TesteStreams {
	...
	public static void main(String[] args) {
		...
		System.out.println("Nomes que contém a letra R: " + estudantes.stream()
		...
		// Retorna um valor booleano de acordo com o critério da busca - true se TODAS as palavras atenderem ao requisito
		System.out.println("Possui a letra q em todos os nomes? " + estudantes.stream()
			.allMatch((elemento) -> elemento.contains("q")));
		
		// Retorna um valor booleano de acordo com o critério da busca - true se PELO MENOS UM
		System.out.println("Alguém possui a letra a no nome? " + estudantes.stream()
			.anyMatch((elemento) -> elemento.contains("a")));
		
		// Retorna um valor booleano de acordo com o critério da busca - true se NINGUÉM atender ao requisito
